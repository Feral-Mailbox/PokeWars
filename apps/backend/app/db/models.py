...
class Unit(Base):
    ...
    level_up_moves = Column(JSON, nullable=False, default=list)
    tm_moves = Column(JSON, nullable=False, default=list)
    egg_moves = Column(JSON, nullable=False, default=list)
    equipped_moves = Column(JSON, nullable=False, default=list)
