...
Revision ID: 07f333b3c101
Revises: 
Create Date: 2025-05-06 21:38:39.916911
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('status', sa.Enum('open', 'in_progress', 'completed', name='gamestatus'), nullable=False),
