...
const STATE_EFFECTS: Record<string, string> = {
  ...
  glaive_rush: "Takes double damage and cannot evade",
  substitute: "A decoy absorbs damage and status",
  disable: "One move cannot be used",
  perish: "Will faint when the countdown ends",
  charge: "Next Electric move is powered up",
  protect: "Protected from attacks",
  recharge: "Must recharge and cannot act",
  leech_seed: "HP is drained each turn",
  trap: "Cannot move and takes damage each turn",
  infatuation: "May be unable to attack",
  underground: "Underground and hard to hit",
  airborne: "In the air and hard to hit",
  underwater: "Underwater and hard to hit",
  shadow: "Vanished and hard to hit",
  solar_beam: "Charging a powerful beam",
  charging: "Preparing a two-turn attack",
};
